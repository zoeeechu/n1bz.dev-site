...
> I do not condone or support using these methods to cheat, gain unfair advantages, or modify commercial games in ways that violate their terms of service. I’m just a student who loves learning about the internals of games, memory, and graphics APIs.
...
well, turns out it's really simple 😎 and it feels really fucking sick doing it. 
...
I get to see my favorite characters in 3D on my screen. it talks to the GPU and says hey buddy load this shit for me. 
...
> other programs can call at runtime they aren't standalone programs you can’t “run” a DLL directly it’s loaded by another executable at runtime.
...
registering it seems long but doesn’t have much going for it either
